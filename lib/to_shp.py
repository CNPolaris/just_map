...
from convert import transform_degree, convert_to_baidu_single, convert_to_tencent_single
from grids import area_to_grid
...
lake_save_path = '{0}boundary.shp'.format(root_path)
island_save_path = '{0}island.shp'.format(root_path)
...
lake = gp.GeoSeries(lake_poly, crs='EPSG:4326')
if lake_save:
...
island = gp.GeoSeries(island_poly, crs='EPSG:4326')
if island_save:
